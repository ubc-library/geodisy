...
public class ENDPOINT_STRINGS {
    public static final String GEOSERVER_BASE_DEV       = "https://geotest.frdr-dfdr.ca/geoserver/";
    public static final String GEOSERVER_BASE_PROD      = "https://prod-gs-g1.frdr.ca:8080/geoserver/";
    ...
    public static final String BACKEND_DEV_ADDRESS      = "geoservertest.frdr.ca";
    public static final String BACKEND_PROD_ADDRESS     = "prod-gs-g1.frdr.ca";

    public static final String DATA_DIR_LOC_LOCAL       = "D:/geodata/geoserver/data/downloads/";
    ...
    public static String PROD_HARVESTER_BASE            = "http://prod-web-g1.frdr.ca/harvestapi/";
