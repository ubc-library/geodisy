...
public class HTTPGetTest {
    public void run(){
        ...
        DataverseRecordFile drf = new DataverseRecordFile("16100046-fra.zip","https://open.canada.ca/data/en/dataset/1c2f7018-0981-4a1e-8560-4ed5524faf32","https://www150.statcan.gc.ca/n1/tbl/csv/16100046-fra.zip");
        ...
        djo.setPID("1c2f7018-0981-4a1e-8560-4ed5524faf32");
